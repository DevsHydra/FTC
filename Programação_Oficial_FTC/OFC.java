...
// Controle do Servo da Lagosta
    ...
    double  speedLagosta = 0.01;     //É somada ou subtraida a "servoLagosta"
...
//  Formulas:
            ...
            double d = Math.hypot(x_1,y_1);         //Hipotenua - Analogico Esquerdo
            double d2 = Math.hypot(x2_1, y2_1);     //Hipotenua - Analogico Direito
...
//  Servo da Pinça
            ...
            if (povU || povR) {                 //Abrindo a pinça
                servoLagosta += speedLagosta;
            }
            else if (povD || povL) {            //Fechando a pinça
                servoLagosta -= speedLagosta;
            }
